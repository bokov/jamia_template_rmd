...
#' ---
#' 
## ----load_packages, echo = F, message=F, warning=F-----------------------------------------------------------------------------------------
...
#' # Results
#' 
## ----define_fig_cap , echo = F,results='hide'----------------------------------------------------------------------------------------------
...
#' 
## ----define_tab1, echo = F, results='hide'-------------------------------------------------------------------------------------------------
...
#' 
#' 
## ----define_tab2, echo = F, results = 'hide'-----------------------------------------------------------------------------------------------
